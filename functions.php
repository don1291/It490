...
function auth($user, $pass) {
    ( $db = mysqli_connect ( 'localhost', 'root', 'Xp193wkey', 'example' ) );
    ...
    $s = "select * from customer where email= '$user' and password = '$pass'";
...
function registration($email,$firstname,$lastname,$password) {
	...
	return false; 
          ...
          mysqli_query($db,"INSERT INTO customer (email, first_name, last_name, password) VALUES ('$email', '$firstname', '$lastname', '$password')");
